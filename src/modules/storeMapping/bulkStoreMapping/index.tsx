...
import Selected from "@/modules/channelMapping/bulkMappings/selected";
import Selecting from "@/modules/channelMapping/bulkMappings/selecting";
import Uploading from "@/modules/channelMapping/bulkMappings/uploading";
import { bulkUploadStoreMappings } from "@/services/thunks/tableApis";
import { useAppDispatch } from "@/store/hooks";
import { downloadCsvFile } from "@/utils";
import styles from "./bulkStoreMappings.module.scss";

type IStatuses = "selecting" | "selected" | "uploading" | "complete";

const BulkStoreMapping = () => {
  ...
  const handleUploadFile = () => {
    if (file) {
      ...
      dispatch(bulkUploadStoreMappings(file))
        .unwrap()
        .then((res) => {
          setServerFile(res);
...
export default BulkStoreMapping;
